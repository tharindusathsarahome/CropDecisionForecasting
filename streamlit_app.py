...
def generate_pdf(text):
    ...
    try:
        ...
        pdf.add_font('IskoolaPota', '', 'Fonts/Iskoola Pota Regular.ttf', uni=True) 
    except RuntimeError:
        st.error("ෆොන්ට් ගොනුව ('Fonts/Iskoola Pota Regular.ttf') සොයාගත නොහැක. කරුණාකර එය නිවැරදිව ස්ථානගත කරන්න.")
        return None
